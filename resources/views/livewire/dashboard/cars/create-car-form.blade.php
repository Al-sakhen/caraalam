    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="registeration_status" class="form-label"><i class="fas fa-id-card me-1"></i>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="used_for" class="form-label"><i class="fas fa-briefcase me-1"></i> Used
                            For</label>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="t_countries">History Countries
                        ...
                        <div wire:ignore>
                            ...
                            ]) name="countries" id="t_countries" required
            ...
            <div class="mt-4 text-end">
                <button type="store" class="btn btn-primary" wire:loading.attr="disabled"
